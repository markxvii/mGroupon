		...
		<ul class="nav">
			<li class="list">
				...
				<dl>
					...
					<dd><nuxt-link to="/order">我的抵用券</nuxt-link></dd>
			...
			<li class="list bd">
				...
				<dl>
					<dd><nuxt-link to="/user">登录商家中心</nuxt-link></dd>
			...
			<li class="list site">
				...
				<div class="subContainer">
					...
					<dl class="app">
						<dt>手机应用</dt>
						<dd>
							<a href=""><img src="https://s0.meituan.net/bs/fe-web-meituan/e5eeaef/img/appicons/meituan.png" alt=""></a>
						</dd>
						<dd>
							<a href=""><img src="https://s0.meituan.net/bs/fe-web-meituan/e5eeaef/img/appicons/meituan.png" alt=""></a>
						</dd>
